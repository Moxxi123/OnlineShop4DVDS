...
function loadDataTable() {
    dataTable = $('#tableData').DataTable({
        ...
        "columns": [
            ...
            { data: 'gameCategory.name', "width": "10%" },
                ...
                "render": function (data, type, row) {
                    return `<div class="d-flex justify-content-center w-100">
                        <div class="btn-group" role="group">
                            <a onClick="changeStatus('/admin/game/changestatus?id=${row.id}')" class="btn btn-primary mx-2">
            ...
            },
            {
                ...
                "render": function (data) {
                    return `<div class="d-flex justify-content-center w-100">
                        <div class="btn-group" role="group">
                            <a href="/admin/game/edit?id=${data}" class="btn btn-primary mx-2"><i class="bi bi-pencil-square"></i> Edit</a>
                            <a onClick="Delete('/admin/game/delete?id=${data}')" class="btn btn-danger mx-2"><i class="bi bi-trash-fill"></i> Delete</a>
                        </div>
                    </div>`;
                },
                "width": "20%"
