...
function loadDataTable() {
    dataTable = $('#tableData').DataTable({
        "ajax": { url: '/admin/recommendslider/getall' },
        "columns": [
            { data: 'name', "width": "15%" },
            {
                data: 'imageUrl',
                ...
                "render": function (data, type, row) {
                    return `<div class="d-flex justify-content-center w-100">
                        <div class="btn-group" role="group">
                            <a onClick="changeStatus('/admin/recommendslider/changestatus?id=${row.id}')" class="btn btn-primary mx-2">
            ...
            },
            {
                ...
                "render": function (data) {
                    return `<div class="d-flex justify-content-center w-100">
                        <div class="btn-group" role="group">
                            <a onClick="Delete('/admin/recommendslider/delete?id=${data}')" class="btn btn-danger mx-2"><i class="bi bi-trash-fill"></i> Delete</a>
                        </div>
                    </div>`;
                },
                "width": "20%"
