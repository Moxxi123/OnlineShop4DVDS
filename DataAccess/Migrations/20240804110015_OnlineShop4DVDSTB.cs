...
{
    /// <inheritdoc />
    public partial class OnlineShop4DVDSTB : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AlbumProducers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CancelRequest = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PromotionPrice = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                    MusicUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PromotionId = table.Column<int>(type: "int", nullable: true),
                    ArtistId = table.Column<int>(type: "int", nullable: false),
                    AlbumProducerId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Albums_AlbumCategories_AlbumCategoryID",
                        column: x => x.AlbumCategoryID,
                        principalTable: "AlbumCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Albums_AlbumProducers_AlbumProducerId",
                        column: x => x.AlbumProducerId,
                        principalTable: "AlbumProducers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Albums_ContentTypes_ContentTypeId",
                        column: x => x.ContentTypeId,
                        principalTable: "ContentTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Albums_Promotions_PromotionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Games_ContentTypes_ContentTypeId",
                        column: x => x.ContentTypeId,
                        principalTable: "ContentTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PromotionPrice = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                    PromotionId = table.Column<int>(type: "int", nullable: true),
                    MovieProducerId = table.Column<int>(type: "int", nullable: false),
                    ProductType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Movies_MovieProducers_MovieProducerId",
                        column: x => x.MovieProducerId,
                        principalTable: "MovieProducers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Movies_Promotions_PromotionId",
                        column: x => x.PromotionId,
                        principalTable: "Promotions",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecommendProductSliders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RecommendProductSliders_ContentTypes_ContentTypeId",
                        column: x => x.ContentTypeId,
                        principalTable: "ContentTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RecommendProductSliders_Promotions_PromotionId",
                        column: x => x.PromotionId,
                        principalTable: "Promotions",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AlbumCategories_Name",
                table: "AlbumCategories",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AlbumProducers_ProducerName",
                table: "AlbumProducers",
                column: "ProducerName",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Albums_AlbumProducerId",
                table: "Albums",
                column: "AlbumProducerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameProducers_ProducerName",
                table: "GameProducers",
                column: "ProducerName",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Games_ContentTypeId",
                table: "Games",
                column: "ContentTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MainBanners_OrderDisplay",
                table: "MainBanners",
                column: "OrderDisplay",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MovieCategories_Name",
                table: "MovieCategories",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MovieProducers_ProducerName",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Movies_MovieProducerId",
                table: "Movies",
                column: "MovieProducerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Promotions_Description",
                table: "Promotions",
                column: "Description",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_RecommendProductSliders_ContentTypeId",
                table: "RecommendProductSliders",
                column: "ContentTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_RecommendProductSliders_PromotionId",
                table: "RecommendProductSliders",
                column: "PromotionId");
        }
